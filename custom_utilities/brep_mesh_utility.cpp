        ...
        Properties::Pointer pProperties)
{
    ...
    {
        KRATOS_ERROR << sample_element_name << " does not exist in the Kratos database";
    }
        ...
        Properties::Pointer pProperties)
{
    ...
    {
        KRATOS_ERROR << sample_condition_name << " does not exist in the Kratos database";
    }
...
std::tuple<ModelPart::NodesContainerType, TEntitiesContainerType, BRepMeshUtility::BoundaryNodesInfoType, BRepMeshUtility::BoundaryLayerInfoType>
                                    ...
                                    Properties::Pointer pProperties)
{
    ...
    {
        KRATOS_ERROR << "ACTIVATION_LEVEL does not exist in the Kratos database";
    }
        ...
        Properties::Pointer pProperties)
{
    ...
    {
        KRATOS_ERROR << "Invalid type " << type;
    }
    ...
    Properties::Pointer pProperties)
{
    ...
    {
        KRATOS_ERROR << "Not sufficient points for line mesh";
    }
    ...
    Properties::Pointer pProperties)
{
    if (sampling_points.size() < 3)
    {
        KRATOS_ERROR << "The given point list is not sufficient for triangulation";
    }
    ...
    for (auto t = triangles.begin(); t != triangles.end(); ++t)
    {
        ...
        {
            // TODO
            KRATOS_ERROR << "type == 2 is not yet implemented";
        }
        ...
        const bool create_condition, Properties::Pointer pProperties)
{
    ...
    {
        KRATOS_ERROR << "Invalid surface geometry type " << static_cast<int>(geom_type);
    }
}
