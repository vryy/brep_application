...
public:
               ...
               const int type, const std::size_t last_node_id)
    {
        ...
        {
            KRATOS_ERROR << "Unknown type " << type;
        }
                  ...
                  const std::size_t& layer, const std::size_t& sub_layer) const
    {
        ...
        if (slice > mrings)
        {
            KRATOS_ERROR << "The slice " << slice << " does not exist";
        }

        if (layer >= mlayers)
        {
            KRATOS_ERROR << "The layer " << layer << " does not exist";
        }

        if (sub_layer >= msub_layers[layer])
        {
            KRATOS_ERROR << "The sub-layer " << sub_layer << " does not exist";
        }
                 ...
                 const std::size_t& layer, const std::size_t& sub_layer) const
    {
        if (ring >= mrings)
        {
            KRATOS_ERROR << "The ring " << ring << " does not exist";
        }
